            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-3">
                        ...
                        <!--incluyendo barra lateral de categorias y marcas-->
                        ...
                        <div class="features_items"><!--features_items-->
                            ...
                            <%  //si la categoria es > 0
                                if (Integer.parseInt(session.getAttribute("category").toString()) > 0) {
                                    ...
                                    datos = ProductoCad.listarProductosActivos(session.getAttribute("moneda").toString());
                                }
                            %>
                                        ...
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <h2 <c:if test="${p.stock==0}"> class="gris"</c:if>>
                                                    <c:choose>
                                                        <c:when test="${p.precio_nuevo!=0}">
                                                            ${sessionScope.moneda}  ${p.precio_nuevo} <strike class="gris">${p.precio}</strike>
                                                        </c:when>
                                                        <c:otherwise>
                                            ...
                                            <ul class="nav nav-pills nav-justified">
                                                ...
                                                <li><a href="#" <c:if test="${p.stock==0}"> class="gris" </c:if>>
                                                        ...
                                                        <c:choose>
                                                            ...
                                                            <c:otherwise>
                                                                <i class="fa fa-look"></i>(<c:out value="${p.stock}"/>) Agotado
                                                            </c:otherwise>
                                                        </c:choose>
